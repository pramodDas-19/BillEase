        ...
        if (fromQuoteId) {
          ...
          if (quote) {
            ...
            setState((prev) => ({
              ...
              isShippingAddressEnabled: Boolean(quote.shippingAddress),
              isShippingSameAsBilling: quote.shippingAddress ? quote.shippingAddress === quote.clientAddress : false,
              isPlaceOfSupplyEnabled: Boolean(quote.placeOfSupply),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const createdInvoice = await InvoiceService.createInvoice({
        ...
        placeOfSupply: state.placeOfSupply || undefined,
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setState((p) => ({
                          ...
                          placeOfSupply: checked ? (p.placeOfSupply || (detectedStateInfo ? detectedStateInfo.stateName : "")) : "",
                        }));
                      }}
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="pt-4 border-t border-slate-200/80 space-y-2.5">
                ...
                >
                  ...
                  <span>{isSubmitting ? "Saving Invoice..." : "Save Invoice"}</span>
                </button>
