...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Platform Super-Admin must use the 2FA-secured /admin console
    if (cleanEmail === "admin@billease.com") {
      setIsLoading(false);
      setErrorMsg("Platform Super-Admin requires 2FA authentication. Please sign in via the Super-Admin Console at /admin");
      return;
    }
